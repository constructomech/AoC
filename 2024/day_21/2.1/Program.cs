...
public sealed class Solution
{
    ...
    private static readonly Dictionary<(Vec2, Vec2, int), long> Memo = new();

    private readonly record struct State(Vec2 Pos, string Sequence)
    {
    ...
    private static long GetSequenceCost(Vec2 start, Vec2 end, Pad pad, int robot)
    {
