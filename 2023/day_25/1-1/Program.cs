...
static class Fun {
    ...
    public static (int nodes0, int nodes1) TestCutsFromGraphViz(Graph graph) {
        // Obtained the answer from graph analysis in GraphViz using Gephi
        var cuts = new List<Connection>() { new Connection("sfd", "ljm"), new Connection("rph", "gst"), new Connection("jkn", "cfn") };
        var alteredGraph = new AlteredGraph(graph, cuts);
    ...
    public static void Run(string[] data) {
        ...
        var (lhs, rhs) = TestCutsFromGraphViz(graph);
