...
for move in moves_str:
    ...
    if cell == '.':
        ...
        while True:
            ...
            if dx != 0:
                next_x = current_x + dx * 2  # Horizontal step: next box is 2 tiles away
                next_y = current_y
            else:
                next_x = current_x
                next_y = current_y + dy  # Vertical step: next box is 1 row away
        ...
        for i in reversed(range(k)):
            if dx != 0:
                # Horizontal movement: boxes are spaced 2 tiles apart
                old_x = start_x + dx * 2 * i
                old_y = start_y
                new_x = old_x + dx
                new_y = old_y
            else:
                # Vertical movement: boxes are spaced 1 row apart
                old_x = start_x
                old_y = start_y + dy * i
                new_y = old_y + dy
