...
void Run(string[] input) {
    ...
    var shortestLengths = allLengths.Take(1000).ToList();

    var pools = new List<HashSet<int>>();
    foreach ((var _, var a, var b) in shortestLengths)
    {
    ...
    var poolSizes = new List<int>(pools.Select(s => s.Count));
    poolSizes.Sort((a, b) => b.CompareTo(a));
